  ...
  createColumn: (column, instance) => {
    return {
      ...
      getFilterFn: () => {
        ...
        return utils.isFunction(column.columnDef.filterFn) ? column.columnDef.filterFn : column.columnDef.filterFn === 'auto' ? column.getAutoFilterFn() : (_ref = userFilterFns == null ? void 0 : userFilterFns[column.columnDef.filterFn]) != null ? _ref : filterFns.filterFns[column.columnDef.filterFn];
      },
      getCanFilter: () => {
