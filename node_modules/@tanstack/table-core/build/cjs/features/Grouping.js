  ...
  createColumn: (column, instance) => {
    return {
      ...
      getAggregationFn: () => {
        ...
        return utils.isFunction(column.columnDef.aggregationFn) ? column.columnDef.aggregationFn : column.columnDef.aggregationFn === 'auto' ? column.getAutoAggregationFn() : (_ref4 = userAggregationFns == null ? void 0 : userAggregationFns[column.columnDef.aggregationFn]) != null ? _ref4 : aggregationFns.aggregationFns[column.columnDef.aggregationFn];
      }
    };
  },
