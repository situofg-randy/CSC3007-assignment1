...
export default function UseFetch() {
  ...
  useEffect(() => {
    ...
    headersHtmlArray.push(<th>national</th>)
    headersHtmlArray.push(<th>central</th>)
    headersHtmlArray.push(<th>west</th>)
    headersHtmlArray.push(<th>east</th>)
    headersHtmlArray.push(<th>north</th>)
    headersHtmlArray.push(<th>south</th>)
